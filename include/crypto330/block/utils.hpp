...
const uint8_t KALYNA_S_BOX[4][256] = {
        {
...
const uint8_t KALYNA_S_BOX_INV[4][256] = {
        {
...
const uint8_t KALYNA_MDS_MATRIX_INV[8][8] = {
...
extern uint8_t gf8_lookup[256][256];
extern uint8_t gf8_lookup_kalyna[256][256];

inline uint8_t GF8_Mul(uint8_t a, uint8_t b) {
    return gf8_lookup[a][b];
}

inline uint8_t GF8_Mul_Kalyna(uint8_t a, uint8_t b) {
    return gf8_lookup_kalyna[a][b];
}
